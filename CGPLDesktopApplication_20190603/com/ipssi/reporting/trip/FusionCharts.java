...
public class FusionCharts {
    ...
    public FusionCharts(ChartInfo chart) {
        this.chartOptions[0] = chart.getId();
        this.chartOptions[1] = chart.getWidth();
        this.chartOptions[2] = chart.getHeight();
        this.chartOptions[3] = chart.getRenderAt();
        this.chartOptions[4] = chart.getType();
        this.chartOptions[5] = chart.getDataFormat();
        if(this.chartOptions[5].contains("url")) {
            this.chartOptions[6] = "\""+chart.getDataSource()+"\"";
        } else {
            this.chartOptions[6] = "__dataSource__";
            this.chartDataSource = this.addSlashes(chart.getDataSource().replaceAll("\n", ""));
        }
    }
