...
public class RFIDSyncMaster {
	...
	public static StringBuilder getProperty(Connection conn, int propertyId, int deviceId, int userId) throws SQLException{
		StringBuilder retval = new StringBuilder();
		StringBuilder result = null;
	    try{
	    	switch(propertyId){
	    	case MINES : result = getMines(conn, deviceId, userId); break;
	    	case DONUMBER : result = getDONumbers(conn, deviceId, userId); break;
	    	case TRANSPORTER : result = getTransporters(conn, deviceId, userId); break;
	    	case GRADES : result = getGrades(conn, deviceId, userId); break;
	    	case USERS : result = getUsers(conn, deviceId, userId); break;
	    	case RELATION :result = getRelations(conn, deviceId, userId); break;
	    	case MINESDEVICES :result = getMinesDevices(conn, deviceId, userId); break;
	    	case FITNESS : result=getFitness(conn, deviceId, userId); break;
	...
	public static StringBuilder setRFIDData(Connection conn, String dataStr, String epcId, String vehicleName, int deviceId, int userId, int updatedBy) throws Exception{
		StringBuilder retval = new StringBuilder();
		//PreparedStatement ps = null;
	    //ResultSet rs = null;
		int logStatus=0;
		...
		try{
			...
			System.out.println("[Web RFID Tag Key]:"+holder.getRecordKey());
	...
	public static StringBuilder setRFIDDataMulti(Connection conn, byte[] dataByte, int formDataLength,int totalBytesRead,int byteRead) throws Exception{
		StringBuilder retval = new StringBuilder();
		//PreparedStatement ps = null;
	    //ResultSet rs = null;
		...
		int logStatus=com.ipssi.gen.utils.Misc.getUndefInt();;
	    RFIDTagInfo tag = null;
	    RFIDHolder holder = null;
	    byte[] data = null;
...
//			throw ex;
	...
	public static StringBuilder getMines(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
		...
		try{//mines_details
			...
			while(rs.next()){
				...
				retval.append("<field id=\"").append(Misc.getRsetInt(rs, "id")).append("\" name=\"").append(rs.getString("name")).append("\" prefix=\"").append(rs.getString("challan_prefix")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getTransporters(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String query = "select transporter_details.id,transporter_details.name,transporter_details.lr_prefix " +
				...
				" transporter_details where status=1"; 
		...
		try{//mines_details
			...
			while(rs.next()){
				...
				retval.append("<field id=\"").append(Misc.getRsetInt(rs, "id")).append("\" name=\"").append(rs.getString("name")).append("\" prefix=\"").append(rs.getString("lr_prefix")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getDONumbers(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
		...
		try{//mines_details
			...
			while(rs.next()){
				...
				retval.append("<field id=\"").append(Misc.getRsetInt(rs, "id")).append("\" name=\"").append(rs.getString("name")).append("\" mines_id=\"").append(rs.getInt("mines_id")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getGrades(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
		...
		try{//mines_details
			...
			while(rs.next()){
				...
				retval.append("<field id=\"").append(Misc.getRsetInt(rs, "id")).append("\" name=\"").append(rs.getString("name")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getUsers(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
	    String query = "select distinct users.id,USERNAME,PASSWORD,NAME from users join mines_users on users.id=mines_users.user_id join mines_devices on mines_devices.mines_id=mines_users.mines_id where isactive=1 and mines_devices.device_id="+ deviceId;
		try{//mines_details
			ps = conn.prepareStatement(query);
			rs = ps.executeQuery();
			while(rs.next()){
				...
				retval.append("<field id=\"").append(Misc.getRsetInt(rs, "id")).append("\" userName=\"").append(rs.getString("USERNAME")).append("\" password=\"").append(rs.getString("PASSWORD")).append("\" name=\"").append(rs.getString("NAME")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getRelations(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
	    String query = "select do_id,grade_id,transporter_id from do_grade_transporter";
		try{//mines_details
			ps = conn.prepareStatement(query);
			rs = ps.executeQuery();
			while(rs.next()){
				...
				retval.append("<field do_id=\"").append(Misc.getRsetInt(rs, "do_id")).append("\" grade_id=\"").append(rs.getInt("grade_id")).append("\" transporter_id=\"").append(rs.getInt("transporter_id")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getMinesDevices(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
	    String query = "select mines_id,device_id,rfFlag, toAllowFlag from mines_devices where status=1 and device_id="+deviceId;
		try{//mines_details
			ps = conn.prepareStatement(query);
			rs = ps.executeQuery();
			while(rs.next()){
				...
				retval.append("<field deviceId=\"").append(Misc.getRsetInt(rs, "device_id")).append("\" minesId=\"").append(rs.getInt("mines_id")).append("\" rfFlag=\"").append(rs.getInt("rfFlag")).append("\" toAllowFlag=\"").append(rs.getInt("toAllowFlag")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
	...
	public static StringBuilder getFitness(Connection conn, int deviceId, int userId) throws SQLException{
		StringBuilder retval = null;
		PreparedStatement ps = null;
	    ResultSet rs = null;
...
+"left outer join vehicle_extended on (vehicle.id=vehicle_extended.vehicle_id) left outer join block_instruction on (vehicle.id=block_instruction.vehicle_id and block_instruction.type=1) left outer join current_data on (vehicle.id =current_data.vehicle_id and current_data.attribute_id=0) where vehicle.status=1 ";
		try{//mines_details
			...
			while(rs.next()){
				...
				retval.append("<field name=\"").append(Misc.getRsetString(rs, "name")).append("\" blacklisted=\"").append(rs.getInt("blacklisted")).append("\" gps_ok=\"").append(rs.getInt("gps_ok")).append("\" paper_ok=\"").append(rs.getInt("paper_ok")).append("\" />");
			}
			if(retval != null)
				retval.append("</object>");
		}catch(Exception ex){
