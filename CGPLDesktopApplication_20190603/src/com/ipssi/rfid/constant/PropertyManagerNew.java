...
public class PropertyManagerNew {
	...
	public enum SystemProperty {
		PRINTER_ADDR, DEBUG, PRINT_ON_SAVE, DIZITIZER_ZERO_FOR_SAVE, CENTERED_FOR_SAVE, DIGITIZER_ZERO, SAME_STATION_MINUTES, SAP_USERNAME,SAP_PASSWORD,AUTO_COMPLETE_ON_OFF;
	}
