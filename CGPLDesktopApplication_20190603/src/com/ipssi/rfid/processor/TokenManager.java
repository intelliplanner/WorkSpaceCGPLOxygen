...
public class TokenManager {
	...
	public static boolean AUTO_COMPLETE_ON_OFF =  false;
	// public static boolean isIssueSampleTag = false;
	...
	public static void initSystemConfig() {
		try {
			...
			AUTO_COMPLETE_ON_OFF = Misc.getParamAsInt(config.getProperty("AUTO_COMPLETE_ON_OFF")) == 0;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
