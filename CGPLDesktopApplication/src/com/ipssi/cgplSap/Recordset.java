...
public class Recordset  implements java.io.Serializable {
    ...
    public Recordset(
           ...
           System.out.println("[Envelop Data: "+ IM_INVOICE_DETAILS.getSALESORDER()+", "+
           IM_INVOICE_DETAILS.getNET_WEIGHT()+", "+
           IM_INVOICE_DETAILS.getTRANSPORTER()+", "+
           IM_INVOICE_DETAILS.getVEHICLE_NO()+", "+
           IM_INVOICE_DETAILS.getSHIPTO()+", "+
           IM_INVOICE_DETAILS.getHSN_NO()+", "+
           IM_INVOICE_DETAILS.getEMPTY_WT()+", "+
           IM_INVOICE_DETAILS.getGROSS_WT()+", "+
           IM_INVOICE_DETAILS.getIN_TIME()+", "+
           IM_INVOICE_DETAILS.getOUT_TIME()+", "+
           IM_INVOICE_DETAILS.getITM_NUMBER()+", "+this.IM_TPRID +" ]");
    }
