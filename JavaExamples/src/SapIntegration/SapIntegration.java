...
//	private String redirectUrl = "http://localhost:8080/LocTracker/SingereniDashBoardData.jsp";
//	TPRecord tprecord;
//	SapIntegration(TPRecord tprecord) {
//		this.tprecord = tprecord;
//	}
//
//	public static void main(String[] args) {
//		TPRecord tpr = null;
//		SapIntegration s = new SapIntegration(tpr);
