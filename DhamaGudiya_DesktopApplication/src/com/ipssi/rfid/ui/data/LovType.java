...
public class LovType {
	...
	public static class PROJECT_SIDE {

		public static final int CGPL = 1;
		public static final int DHAMA_GUDIYA = 2;
	
		public static enum POJECT_AREA{
			CGPl,DHAMA_GUDIYA
		}	
		
		public static String getProjectName(POJECT_AREA enm) {
			switch(enm) {
				case CGPl:return "Welcome To CGPL"; 	
				case DHAMA_GUDIYA: return "Welcome to DHAMA GUDIYA";
				default: return "Welcome To CGPL"; 	
			}
		}
		...
		public static String getStr(int id) {
			switch(id) {
				case CGPL:return "CGPL"; 	
				case DHAMA_GUDIYA: return "DHAMA GUDIYA";
				default: return "CGPL"; 	
			}
		}
