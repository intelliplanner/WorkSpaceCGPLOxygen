...
public class LovDao {
	...
	public static enum LovItemType {
		VEHICLE, PO_SALES_ORDER,SALES_ORDER, TRANSPORTER,DHAMA_GODIYA_TRANSPORTER,DHAMA_GODIYA_GRADE,DHAMA_GODIYA_MINES,DHAMA_GODIYA_DO_NO, CUSTOMER, PO_LINE_ITEM, DATA_ENTRY_TYPE, DL_NUMBER,DRIVER_NAME,AUTO_COMPLETE_VEHICLE,PROCESSING_STATUS,OPEN_CLOSE,HOUR,MINUTE,INVOICE_CANCEL,INVOICE_STATUS,PRINTER,PROJECT_AREA
	}
