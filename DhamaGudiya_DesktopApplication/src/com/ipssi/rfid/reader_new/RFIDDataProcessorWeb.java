...
public class RFIDDataProcessorWeb {
	...
	public RFIDDataProcessorWeb(int readerId, int workStationType, int workStationTypeId, int userId) {
										...
										if (true) {// tag != null) {
											...
											RFIDTagInfo tag = workStationType <= Type.WorkStationType.WEIGH_BRIDGE_IN_TYPE
													? RFIDMaster.getReader(readerId)
															...
															tagListener.manageTag(conn, token, null,null, null);
