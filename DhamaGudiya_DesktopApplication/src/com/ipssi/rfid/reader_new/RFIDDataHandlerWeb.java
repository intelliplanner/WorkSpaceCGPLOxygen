package com.ipssi.rfid.reader_new;

import com.ipssi.rfid.readers.*;
import com.ipssi.gen.utils.Triple;
import com.ipssi.rfid.beans.TPRecord;
import com.ipssi.rfid.beans.Token;
import com.ipssi.rfid.processor.TPRBlockManager;

public class RFIDDataHandlerWeb implements Runnable {

	Thread mThread = null;
	int refrehTime;
	private Object obj = new Object();
	RFIDDataProcessorWeb rfidProcessor = null;
	private int readerId = 0;
	private boolean isRunning = false;

	public RFIDDataHandlerWeb(int refrehTime, int readerId, int workStationType, int workStationTypeId, int userId) {
		this.refrehTime = refrehTime;
		this.readerId = readerId;
		this.rfidProcessor = new RFIDDataProcessorWeb(readerId, workStationType, workStationTypeId, userId);
	}
