...
public class Grade {
	...
	public Grade(int id, int status, String name, String sapCode, String code, int portNodeId, int createdBy,
			Date createdOn, Date updatedOn, int updatedBy) {
		super();
		this.id = id;
		this.status = status;
		this.name = name;
	...
	public String toString() {
		return "Grade [id=" + id + ", status=" + status + ", name=" + name + ", sapCode=" + sapCode + ", code=" + code
				+ ", portNodeId=" + portNodeId + ", createdBy=" + createdBy + ", createdOn=" + createdOn
