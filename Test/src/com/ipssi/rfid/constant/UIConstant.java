...
public class UIConstant {
    ...
    public static final String formTitle = "RFID6.9";
    ...
    public static String NO_TARE_FOUND="No Valid Tare found";
    public static String LESS_TARE_FOUND="Lower Tare Weight Found";
    public static String MORE_TARE_FOUND="Higher Tare Weight Found";
    public static String LESS_GROSS_FOUND="Lower Gross Weight Found";
    public static String MORE_GROSS_FOUND="Higher Gross Weight Found";
    ...
    private static void listComponents(java.awt.Container c){
    	...
    	if(c instanceof javax.swing.JButton){
    		...
    		javax.swing.Action spaceAction=btn.getActionMap().get(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_SPACE,0));
