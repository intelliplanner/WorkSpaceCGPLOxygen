 ...
 */
public class LoadGateController implements ControllerI,Initializable {
    ...
    public void init(MainController parent, Parent rootView, MenuItemInfo menuItemInfo) {
        ...
        gateInController.init("Gate Entry Information", Type.Reader.IN, Type.RFID_AREA_TYPE.LOAD);
        gateOutController.init("Gate Exit Information", Type.Reader.OUT, Type.RFID_AREA_TYPE.LOAD);
    }
...
//        textBoxVehicleName.setEditable(enable);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        //TextFields.bindAutoCompletion(textBoxVehicleName, t-> LovDao.getVehicleList(t.getUserText()));
    }
