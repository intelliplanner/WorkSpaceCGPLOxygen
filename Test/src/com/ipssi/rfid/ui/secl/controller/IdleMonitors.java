...
public class IdleMonitors {

    private final Timeline idleTimeline ;
    private final EventHandler<Event> userEventHandler ;
    public IdleMonitors(Duration idleTime, Runnable notifier, boolean startMonitoring) {
    ...
    public IdleMonitors(Duration idleTime, Runnable notifier) {
