...
public class RFIDConfig {
	...
	private String readerDesktopServer = "192.168.1.191";
	private int readerDesktopPort = 6001;
	...
	private int readerDesktopConnectionType = READER_TYPE_TCPIP;
	...
	public String getReaderDesktopServer() {
		return readerDesktopServer;
	}

	public void setReaderDesktopServer(String readerDesktopServer) {
		this.readerDesktopServer = readerDesktopServer;
	}

	public int getReaderDesktopPort() {
		return readerDesktopPort;
	}

	public void setReaderDesktopPort(int readerDesktopPort) {
		this.readerDesktopPort = readerDesktopPort;
	}

	public int getReaderDesktopConnectionType() {
		return readerDesktopConnectionType;
	}

	public void setReaderDesktopConnectionType(int readerDesktopConnectionType) {
		this.readerDesktopConnectionType = readerDesktopConnectionType;
	}
