...
public class RFIDDataHandler implements Runnable {
	...
	public void start() {
		...
		if(cfg == null || (readerId == 0 && !cfg.isReaderOneValid()) || (readerId == 1 && !cfg.isReaderTwoValid()))
			return;
		stop();
		mThread = new Thread(this);
		mThread.setName("RfidDataHandler "+readerId);
		mThread.start();
	}
	...
	public RFIDDataProcessor getRfidProcessor(){
		return this.rfidProcessor;
	}
}
