...
public class dateTest {
	public static void main(String[] args) {
		...
		String string4 = "2021-07-30";
		DateFormat inFormat3 = new SimpleDateFormat("dd-MM-yyyy hh:mm aa");
		DateFormat outFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
		
		DateFormat inFormat4 = new SimpleDateFormat("yyyy-MM-dd");
...
//		}
		...
		try {
			...
			System.out.println(new SimpleDateFormat("yyyy-MM-dd").parse(string4));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
//		 outFormat.parse(source)
