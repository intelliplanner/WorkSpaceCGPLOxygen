...
public class ScreenConstant {
	...
	public static final String VERSION = "Prod 2.8";
	...
	public static final String BASE = "/com/ipssi/ppgcl/ui/view/";// com.ipssi.ppgcl.ui.view
	...
	public static class SCREEN_IMAGES {
		public static final String APPLICATION_ICON = IMAGE_BASE + "logo_ppgcl.png";
	}

	
	public static class BlockScreens {

		public static final String SETTING_WINDOW =  "Settings.fxml";
	}
	...
	public static class ScreenLinks {
		...
		public static final String ISSUE_TAG_WINDOW = BASE + "IssueTagWindow.fxml";
//		public static final String REGISTRATION = BASE + "IssueTagWindow.fxml";
		/*----------------------------Setting Screens----------------------------------*/
		...
		public static final String WEIGHBRIDGE_TCP_SETTING_WINDOW = BASE + "WeighBridgeTCPWindowSetting.fxml";
		...
		public static final String SALES_ORDER_WINDOW = BASE + "SalesOrderWindow.fxml";
		public static final String SALES_ORDER_UPDATE_WINDOW = BASE + "SalesOrderUpdateWindow.fxml";
	...
	public static class ScreenTitle {
		...
		public static final String SALES_ORDER_WINDOW = "SALES ORDER";
		public static final String SALES_ORDER_UPDATE_WINDOW = "UPDATE SALES ORDER";
	...
	public static class MenuItemId {
		...
		public static final String REGISTRATION_WINDOW = "Registration";
		...
		public static class MenuTitle {
			...
			public static final String SALES_ORDER_WINDOW = "SALES_ORDER_WINDOW";
		}
		...
		public static class MENU_PRIV {
			...
			public static final int ISSUE_TAG_WINDOW = 80109;
			public static final int SALES_ORDER_WINDOW = 80110;
			public static final int ALLOW_CREATE_INVOICE = 80111;
