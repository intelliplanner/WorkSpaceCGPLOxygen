...
public class SystemConfigurationSettingController implements Initializable, ControllerI {
    ...
    private void loadSystemConfigurationProperties(Object object) {
        ...
        try {
            ...
            if (prop != null) {
                ...
                TEXTBOX_RELAY_ONE.setText(Misc.getParamAsString(prop.getProperty("READER_TWO_RELAY_ID"), ""));
                TEXTBOX_RELAY_TWO.setText(Misc.getParamAsString(prop.getProperty("READER_ONE_RELAY_ID"), ""));
                ...
                TEXTBOX_SAP_HTTP_PORT.setText(Misc.getParamAsString(prop.getProperty("SAP_INVOICE_CANCELLATION_URL"), "http://tpcped.tpc.co.in:8000/sap/bc/srt/rfc/sap/zws_inv_cancel_ppgcl_vts/400/zws_inv_cancel_ppgcl_vts/zvts_serv_binding"));
                TEXTBOX_SAP_HTTPS_PORT.setText(Misc.getParamAsString(prop.getProperty("SAP_INVOICE_CREATION_URL"), "http://tpcped.tpc.co.in:8000/sap/bc/srt/rfc/sap/zws_inv_ppgcl_vts/400/zws_inv_ppgcl_vts/zvts_serv_binding"));
    ...
    public boolean save() {
        ...
        PropertyManagerNew.setProperty(PropertyManagerNew.PropertyType.Systems, "SAP_INVOICE_CANCELLATION_URL", TEXTBOX_SAP_HTTP_PORT.getText());
        PropertyManagerNew.setProperty(PropertyManagerNew.PropertyType.Systems, "SAP_INVOICE_CREATION_URL", TEXTBOX_SAP_HTTPS_PORT.getText());
