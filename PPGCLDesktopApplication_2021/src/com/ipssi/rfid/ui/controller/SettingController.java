...
public class SettingController implements Initializable, ControllerI {
	...
	@FXML
	private JFXButton CONTROL_SALES_ORDER_CONFIG_SETTING;
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		setSettingTabsVisible(false);
	}

	private void setSettingTabsVisible(boolean salesOrderVisible) {
		CONTROL_SALES_ORDER_CONFIG_SETTING.setVisible(salesOrderVisible);
	}

	@Override
	public void clearInputs() {
		if (this.currentSettingViewController != null)
			this.currentSettingViewController.clearInputs();
	}
	...
	private void handleActionControl(Button control) {
		...
		case "CONTROL_BARRIER_CONFIG_SETTING":
			...
			setSettingControllsColor(control, "#ff4000");
			break;
		case "CONTROL_SALES_ORDER_CONFIG_SETTING":
			salesOrderConfigAction();
			setSettingControllsColor(control, "#ff4000");
			break;
		case "CONTROL_SAVE":
			save();
...
//			CONTROL_GATE_IN_SETTING.requestFocus();
	...
	private void salesOrderConfigAction() {
	...
	private void weighBridgeConfigAction() {
		loadScreen(ScreenConstant.ScreenLinks.WEIGHBRIDGE_TCP_SETTING_WINDOW,
	...
	private void setSettingControllsColor(Button control, String fontcolor) {
		...
		CONTROL_SALES_ORDER_CONFIG_SETTING.setStyle("-fx-text-fill:#ffffff;");
		control.setStyle("-fx-text-fill:#ff0000;");
	}
