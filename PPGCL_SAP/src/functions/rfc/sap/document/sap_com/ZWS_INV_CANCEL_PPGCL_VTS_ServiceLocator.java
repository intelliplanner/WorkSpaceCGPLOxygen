...
public class ZWS_INV_CANCEL_PPGCL_VTS_ServiceLocator extends org.apache.axis.client.Service implements functions.rfc.sap.document.sap_com.ZWS_INV_CANCEL_PPGCL_VTS_Service {
    ...
    public functions.rfc.sap.document.sap_com.ZWS_INV_CANCEL_PPGCL_VTS_PortType getZVTS_SERV_BINDING() throws javax.xml.rpc.ServiceException {
    ...
    public functions.rfc.sap.document.sap_com.ZWS_INV_CANCEL_PPGCL_VTS_PortType getZVTS_SERV_BINDING(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            functions.rfc.sap.document.sap_com.ZVTS_SERV_BINDINGStubCancelInvoice _stub = new functions.rfc.sap.document.sap_com.ZVTS_SERV_BINDINGStubCancelInvoice(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (functions.rfc.sap.document.sap_com.ZWS_INV_CANCEL_PPGCL_VTS_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                functions.rfc.sap.document.sap_com.ZVTS_SERV_BINDINGStubCancelInvoice _stub = new functions.rfc.sap.document.sap_com.ZVTS_SERV_BINDINGStubCancelInvoice(new java.net.URL(ZVTS_SERV_BINDING_address), this);
                _stub.setPortName(getZVTS_SERV_BINDINGWSDDServiceName());
                return _stub;
            }
        }
